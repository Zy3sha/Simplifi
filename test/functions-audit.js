...
assert("account auth callable functions are source-tracked", source.includes("exports.usernameStatus = onCall") && source.includes("exports.accountLogin = onCall") && source.includes("exports.resetAccountPin = onCall") && source.includes("exports.accountSignInStatus = onCall") && source.includes("exports.repairAccountSignIn = onCall") && source.includes("exports.saveRecoveryEmail = onCall") && source.includes("exports.recoveryEmailLookup = onCall"));
