...
assert("main app importer rehomes after-midnight imported night milk to the bedtime day", app.includes("function rehomeWakeModeNightImports()") && app.includes('if (dayBoundary !== "wake") return;') && app.includes('const isNightMilk = entry.type === "feed" && entry.feedType !== "solids";') && app.includes("rehomeWakeModeNightImports();"));
