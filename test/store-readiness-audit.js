...
assert("Android manifest avoids restricted or high-risk store permissions", !/(USE_EXACT_ALARM|SCHEDULE_EXACT_ALARM|REQUEST_INSTALL_PACKAGES|QUERY_ALL_PACKAGES|ACCESS_FINE_LOCATION|ACCESS_COARSE_LOCATION)/.test(androidManifest));
