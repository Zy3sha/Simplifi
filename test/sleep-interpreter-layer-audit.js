...
assert("Long-wake explanation mentions correlations only when the data has one", app.includes("function buildSplitNightCrossLogWhy") && app.includes("No clear cause is strong enough yet") && app.includes("Useful clues:") && app.includes("Most likely cause: ") && app.includes("Evidence so far:") && app.includes("humanizeSplitNightPrimaryPressure") && app.includes("splitNightCrossLogSignals") && app.includes("splitNightPrimaryPressure") && app.includes("logged daytime milk") && app.includes("wet nappies were") && app.includes("recent milestone logged") && app.includes("crossLogWhy: _crossLogWhy") && app.includes("_diag.crossLogWhy") && app.includes("diagnosis.crossLogWhy") && !app.includes("Looking across feeds, nappies, day sleep and development") && !app.includes("No clear correlation is strong enough yet") && !app.includes("The useful clues are:"));
...
assert("Night diagnosis reads notes and stored bedtime resistance before calling a night normal", app.includes("function nightWakeDurationMinutes") && app.includes("function nightWakeLooksDifficult") && app.includes("ob_bedtime_resistance_") && app.includes("const _bedtimeResistance = _ctx.bedtimeResistance || null") && app.includes('type: "bedtime_resistance"') && app.includes("Bedtime was hard last night") && app.includes("I won't flatten this into a normal night") && app.includes("I won't call that normal just because"));
