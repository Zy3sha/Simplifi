...
assert("Sleep interpreter can surface false starts, split nights and hard settling into Understand Sleep", app.includes("analyzeLastNight(days, prevDay, dayKey)") && app.includes("diagnoseNightPattern(lastNight") && app.includes('primaryAction: {label:"Open sleep insight", action:"open_sleep_insight"}') && app.includes('["overtired","undertired","habit","hunger","developmental_disruption","split_night","false_start","bedtime_resistance","settling_difficulty","fragmented_night"]') && app.includes("False start after bedtime") && app.includes("Possible split night") && app.includes("Bedtime was hard") && app.includes("Hard settling night") && app.includes("Fragmented night"));
assert("Split-night explanation cross-checks feeds nappies day sleep development and milestones", app.includes("function buildSplitNightCrossLogWhy") && app.includes("Looking across feeds, nappies, day sleep and development") && app.includes("humanizeSplitNightPrimaryPressure") && app.includes("splitNightCrossLogSignals") && app.includes("splitNightPrimaryPressure") && app.includes("logged daytime milk") && app.includes("wet nappies were") && app.includes("recent milestone logged") && app.includes("nightDiagnosis.crossLogWhy") && app.includes("_diag.crossLogWhy") && app.includes("_nightDiag5.crossLogWhy"));
assert("Last night's debrief shows intelligence signals instead of hiding them in the engine", app.includes("lastNight.intelligenceSignals") && app.includes('data-testid="last-night-intelligence-signals"') && app.includes("Split-night signal") && app.includes("wake within 1-2h of bedtime") && app.includes("Bedtime resistance") && app.includes("wakes need watching"));
