...
assert("logout keeps only device-level preferences", logoutBlock.includes('k === "ob_theme"') && logoutBlock.includes('k === "ob_widget_theme"') && logoutBlock.includes('k === "ob_locale"') && logoutBlock.includes("k === HAPTICS_DISABLED_KEY") && !/const keep[\s\S]{0,260}"bio_pin"/.test(logoutBlock));
